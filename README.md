...
Example animation generated by this implementation for low noise (organized motion) and high noise (chaotic motion):

![Animation](animation_chaotic.gif)

![Animation](animation_organized.gif)
